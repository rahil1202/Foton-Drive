...
const Header = ({ title = 'Dashboard', description = '', className = '', icon = null }) => {
  ...
  return (
    <header
      className={twMerge(
        'w-full px-4 sm:px-6 py-5 flex items-center justify-between bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 shadow-md mb-6 transition-all duration-300',
        className
      )}
    >
